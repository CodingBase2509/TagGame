...
public class EncryptionTests : TestBase
{
    ...
    private readonly Mock<IOptions<JsonSerializerOptions>> _jsonOptionsMock;
    ...
    public EncryptionTests()
    {
        ...
        _jsonOptionsMock = new Mock<IOptions<JsonSerializerOptions>>();
        _jsonOptionsMock.Setup(x => x.Value)
            .Returns(() =>
            {
    ...
    private Encryption CreateEncryption() =>
        new Encryption(_secureStorageMock.Object, _jsonOptionsMock.Object).WithStorageKey(_storageKey);
    ...
    public async Task EncryptAsync_ShouldReturnEmpty_WhenKeyOrIvMissing()
    {
        ...
        var encryption = new Encryption(brokenStorageMock.Object, _jsonOptionsMock.Object).WithStorageKey(_storageKey);
    ...
    {
        var encryption = new Encryption(_secureStorageMock.Object, _jsonOptionsMock.Object);
